...
function anim_move_top_card_marketX(deck, market) {
	...
	a.onfinish = () => {
		...
		//mContainerSplay(market.container, 2, CWIDTH, CHEIGHT, market.list.length, OVW);
		//mItemSplay(topmost, market.list, 2, OVW);
		qanim();
	};
