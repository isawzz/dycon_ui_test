...
async function onclick_modify_save(){
	//modify DB and save to saves
	//let dbnew = jsCopy(DB);
	//dbnew.users = {hallo:'jajaja'};
	//postData1(SERVER, { answer: 42 });
	//let res = await postData(SERVER + '/save_file/db.txt/', { agent: 'hallo', timeout: 25 });	
	//console.log('res',res);
...
function onclick_run_tests() {
	...
	if (nundef(TestList)) {
		console.log('taking default TestList');
		TestList = [100, 101];
	}
