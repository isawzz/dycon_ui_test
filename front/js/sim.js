TestList = arrRange(100, 113); //[];// [100, 101, 102, 103, 104];
TestNumber = 306; // do NOT set this to 107 in real mode!
...
// 	TestList=[100,101,102];

// 	//wie starte ich die tests?
// 	test_engine_run_next(TestList);
// }
function test_engine_run_next(list) {
	if (nundef(list)) {
		list = TestList = arrRange(100, TestNumber - 1); //[101, 102, 103];
		//console.log('setting TestList to',TestList,'TestNumber',TestNumber)
	}
